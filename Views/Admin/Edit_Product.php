...
<html>
	<head>
		...
		<script type="text/javascript" src="../../Sources/JS/bootstrap-filestyle.min.js"> </script>
	...
	<fieldset class="well">
		...
		<form action="../edit_product" method="post" id="pro_form" enctype="multipart/form-data"> 
